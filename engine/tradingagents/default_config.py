...
DEFAULT_CONFIG = _apply_env_overrides({
    ...
    "data_vendors": {
        "core_stock_apis": "wind",       # Options: wind, alpha_vantage, yfinance
        "technical_indicators": "wind",  # Options: wind, alpha_vantage, yfinance
        "fundamental_data": "wind",      # Options: wind, alpha_vantage, yfinance
        "news_data": "wind",             # Options: wind, alpha_vantage, yfinance
        "macro_data": "wind",            # Options: wind, fred (needs FRED_API_KEY)
        "prediction_markets": "wind",    # Options: wind, polymarket (keyless)
    },
