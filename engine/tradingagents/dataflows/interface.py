...
from .wind import (
    get_balance_sheet as get_wind_balance_sheet,
    get_cashflow as get_wind_cashflow,
    get_fundamentals as get_wind_fundamentals,
    get_global_news as get_wind_global_news,
    get_income_statement as get_wind_income_statement,
    get_insider_transactions as get_wind_insider_transactions,
    get_macro_indicators as get_wind_macro_indicators,
    get_news as get_wind_news,
    get_prediction_markets as get_wind_prediction_markets,
    get_stock_data as get_wind_stock_data,
)
...
VENDOR_METHODS = {
    ...
    "get_stock_data": {
        ...
        "wind": get_wind_stock_data,
    },
    # technical_indicators
    # wind 复用本地 stockstats 计算（load_ohlcv 已路由到 Wind），指标定义一致。
    "get_indicators": {
        "alpha_vantage": get_alpha_vantage_indicator,
        "yfinance": get_stock_stats_indicators_window,
        "wind": get_stock_stats_indicators_window,
    },
    # fundamental_data
    "get_fundamentals": {
        "alpha_vantage": get_alpha_vantage_fundamentals,
        "yfinance": get_yfinance_fundamentals,
        "wind": get_wind_fundamentals,
    },
    "get_balance_sheet": {
        "alpha_vantage": get_alpha_vantage_balance_sheet,
        "yfinance": get_yfinance_balance_sheet,
        "wind": get_wind_balance_sheet,
    },
    "get_cashflow": {
        "alpha_vantage": get_alpha_vantage_cashflow,
        "yfinance": get_yfinance_cashflow,
        "wind": get_wind_cashflow,
    },
    "get_income_statement": {
        "alpha_vantage": get_alpha_vantage_income_statement,
        "yfinance": get_yfinance_income_statement,
        "wind": get_wind_income_statement,
    },
    # news_data
    "get_news": {
    ...
    "get_global_news": {
        ...
        "wind": get_wind_global_news,
    },
    "get_insider_transactions": {
        "alpha_vantage": get_alpha_vantage_insider_transactions,
        "yfinance": get_yfinance_insider_transactions,
        "wind": get_wind_insider_transactions,
    },
    # macro_data
    "get_macro_indicators": {
        "fred": get_fred_macro_data,
        "wind": get_wind_macro_indicators,
    },
    # prediction_markets
    "get_prediction_markets": {
        "polymarket": get_polymarket_prediction_markets,
        "wind": get_wind_prediction_markets,
    },
}
